  ...
  return (
    <Switch>
      <Route
        exact
        path="/"
        render={(props) => <SongsList isAppIntroDisplayed {...props} />}
      />
      <Route
        exact
        path="/create"
        render={(props) => <CreateSong user={user} {...props} />}
      />
      ...
      <Route
        ...
        render={(props) => {
          if (!user) {
            return (
              <Auth setUser={setUser} variant={Variant.login} {...props} />
            );
          } else {
            return <Redirect to="/" />;
          }
      ...
      <Route
        ...
        render={(props) => {
          if (!user) {
            return (
              <Auth setUser={setUser} variant={Variant.signup} {...props} />
            );
          } else {
            return <Redirect to="/" />;
          }
      ...
      <Route
        exact
        path="/listen"
        render={(props) => <SongsList isAppIntroDisplayed={false} {...props} />}
      />
      <Route
        exact
        path="/load-song"
